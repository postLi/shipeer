          ...
          <ul>
            <li>
              <div class="liImg">
                ...
                <img v-if="userInfoData.shipperCardFile===''|| userInfoData.shipperCardFile === null "
                     class="user-avatar" src="../../assets/default_tx.png">
              ...
              <div class="liOther">
                ...
                <span class="spanClass" @click="gotoAttest" v-if="userInfoData.shipperStatus === 'AF0010403'">去认证</span>
              </div>
            </li>
      ...
      getCouponCountInfo() {
        ...
        return getCouponCount().then(res => {
          if (res.status === 200) {
            ...
            this.$message.error('错误：' + (err.text || err.errorInfo || err.data || JSON.stringify(err) || '无法获取服务端数据'))
          }
